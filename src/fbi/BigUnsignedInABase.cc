...
BigUnsignedInABase::BigUnsignedInABase() : NumberlikeArray<Digit>(), base(2) {}

BigUnsignedInABase::BigUnsignedInABase(const BigUnsignedInABase& x) : NumberlikeArray<Digit>(x), base(x.base) {}

BigUnsignedInABase& BigUnsignedInABase::operator=(const BigUnsignedInABase& x)
{
...
BigUnsignedInABase::BigUnsignedInABase(const Digit* d, Index l, Base base) : NumberlikeArray<Digit>(d, l), base(base)
{
    // Check the base
    if (base < 2)
...
BigUnsignedInABase::Base BigUnsignedInABase::getBase() const
{
    return base;
}

BigUnsignedInABase::Digit BigUnsignedInABase::getDigit(Index i) const
{
