...
{
    if (sign == negative)
        throw SignError{ "BigInteger::convertToUnsignedPrimitive",
...
X BigInteger::convertToSignedPrimitive() const
{
    ...
    throw MathError{ "BigInteger::convertToSignedPrimitive", "Value is too big to fit in the requested type" };
}
